...
# releasing the mouse button or N or M key to teleport the dots to 
...
from pygame import QUIT, Color, MOUSEBUTTONUP, KEYDOWN, K_q, K_n, K_m
...
class Game:
    ...
    def play(self):
        ...
        # or the Q key and then close the window.
    ...
    def handle_one_event(self, event):
        ...
        if event.type == QUIT:
            ...
            if event.key == K_q:
                self._close_selected = True
            elif self._continue_game and (event.key == K_n or event.key == K_m):
                self.handle_press()
        elif self._continue_game and event.type == MOUSEBUTTONUP:
            self.handle_press()

    def handle_press(self):
        # Respond to the player releasing the mouse button or N or M key
        # by taking appropriate actions.
        # - self is the Game where the mouse up or
        # N or M key press occurred.
    ...
    def draw_game_over(self):
        ...
        # - self is the Game to draw GAME OVER for.
...
class Dot:
    ...
    def __init__(self, color, center, radius, velocity, window):
        ...
        # - velocity is a list containing
        # the x and y components of the speed of the dot.
    ...
    def intersects(self, dot):
        ...
        # they do not.
        # - self is the first Dot.
        # - dot is the second Dot.
